...
import EditEventModalConfirmation from './EditEventModal';
import DeleteEventModalConfirmation from './DeleteEventModal';
...
const EditEvent=()=>{
    ...
    const [openEditEventModalconfirm, setEditEventModalconfirm] = useState(false);
    const [openDeleteEventModalconfirm, setDeleteEventModalconfirm] = useState(false);
    const [openEditLocationModal, setEditLocationModal] = useState(false);
        ...
        <div className='background'>
            ...
            <div className='content-event-container'>
                ...
                <div className='event-topic-text'>
                    ...
                    <input type='text' className='input-event-location' placeholder='Select Location' required readOnly onClick={() => {setEditLocationModal(true)}}></input>
                    <LocationOnIcon className='location-icon'/>
                </div>
                <div className='edit-event-btn'><button onClick={() => {setEditEventModalconfirm(true)}}>Edit Event</button></div>
                <div className='delete-event-btn'><button onClick={() => {setDeleteEventModalconfirm(true)}}>Delete Event</button></div>
            </div>
            {openEditLocationModal && <EditLocationModal closeEditLocationModal={setEditLocationModal}/>}
            {openEditEventModalconfirm && <EditEventModalConfirmation closeEditEventModalconfirm={setEditEventModalconfirm}/>}
            {openDeleteEventModalconfirm && <DeleteEventModalConfirmation closeDeleteEventModalconfirm={setDeleteEventModalconfirm}/>}
        </div>
    )
}
